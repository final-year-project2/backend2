...
from .views import  SaveTicketView,BecomeSellerAPIView, CheckSellerView ,RetriveTicketList,SelectWinnerView,SendLiveTicket
...
urlpatterns = [
    ...
    path('live_ticket_list/<int:seller_id>', SendLiveTicket.as_view(), name='select_winner'),
